...
<details>
  ...
  <ol>
    <li>
      ...
      <ul>
        <li><a href="#1-add-to-an-existing-project">1. Add to an Existing Project</a></li>
        <li><a href="#2-start-a-new-project">2. Start a New Project</a></li>
      </ul>
    </li>
  </ol>
</details>
...
<!-- Add this for a "back to top" button, include the "---" below -->
